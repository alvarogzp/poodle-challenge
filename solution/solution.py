...
class PoodleBlockExchanger:
    ...
    def exchange_blocks(self):
        ...
        block_to_inject = self.data[
                          -BLOCK_LENGTH * (DECRYPT_BLOCK_FROM_LAST):-BLOCK_LENGTH * (DECRYPT_BLOCK_FROM_LAST - 1)]
        self.previous_block = self.data[
                              -BLOCK_LENGTH * (DECRYPT_BLOCK_FROM_LAST + 1):-BLOCK_LENGTH * (DECRYPT_BLOCK_FROM_LAST)]
    ...
    def get_decrypted_char(self):
        ...
        return chr(
            last_block_last_byte_plaintext ^ second_to_last_block_last_byte_ciphertext ^ previous_block_last_byte_ciphertext)
